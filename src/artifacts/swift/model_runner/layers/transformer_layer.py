...
from src.artifacts.swift.model_runner.utils import LlamaModelConfig, LlamaInferState
from src.artifacts.swift.model_runner.args import ModelRunnerArgs
from src.artifacts.swift.model_runner.utils import LlamaTransformerLayerWeight

from src.artifacts.swift.model_runner.kernels.linear import linear
from src.artifacts.swift.model_runner.kernels.rmsnorm import fused_add_rmsnorm_inplace
from src.artifacts.swift.model_runner.kernels.rotary_emb import rotary_embedding_inplace
from src.artifacts.swift.model_runner.kernels.paged_attn import paged_attention
from src.artifacts.swift.model_runner.kernels.kvcache_mgmt import store_kvcache
from src.artifacts.swift.model_runner.kernels.silu_and_mul import silu_and_mul_inplace

class LlamaTransformerLayer:
    def __init__(
        self,
        model_config: LlamaModelConfig,
        engine_config: ModelRunnerArgs,
